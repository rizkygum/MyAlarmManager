package com.bdd.myalarmmanager
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_once_time -> {
                ...
                timePickerFragmentOne.show(fragmentManager, TIME_PICKER_ONCE_TAG)
            }
            ...
            R.id.btn_repeating_time ->{
                ...
                timePickerFragmentRepeat.show(fragmentManager, TIME_PICKER_REPEAT_TAG)
            }
